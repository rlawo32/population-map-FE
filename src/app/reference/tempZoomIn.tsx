...
const TempZoomIn = () => {
    ...
    return (
        <BtnSection $x={x} $y={y} $size={size}>
            <div className="btn_up" onClick={(e) => {setX(e.currentTarget.getBoundingClientRect().x), setY(e.currentTarget.getBoundingClientRect().y), setSize(1.5), console.log(e.currentTarget.getBoundingClientRect())}}>up</div>
